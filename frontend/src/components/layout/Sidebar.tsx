...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 z-40 flex h-full w-56 flex-col border-r border-border-primary bg-bg-secondary">
      {/* Logo */}
      <div className="flex h-14 items-center gap-2.5 border-b border-border-primary px-4">
        ...
        <div className="flex flex-col">
          <span className="text-sm font-semibold text-text-primary leading-tight">SAW</span>
          <span className="text-[10px] text-text-muted leading-tight">Workbench v0.7.0</span>
        </div>
      </div>
